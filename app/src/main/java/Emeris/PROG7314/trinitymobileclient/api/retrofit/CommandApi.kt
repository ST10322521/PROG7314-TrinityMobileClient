...
interface CommandApi {
     ...
     */
    @POST("api/v1/commands/{agentId}/execute/bof")
    suspend fun queueBofCommand(@Path("agentId") agentId: kotlin.Int, @Body bofDTO: BofDTO? = null): Response<Unit>
     ...
     */
    @POST("api/v1/commands/{agentId}/execute/cancelFileDownload")
    suspend fun queueCancelFileDownloadCommand(@Path("agentId") agentId: kotlin.Int, @Body cancelDownloadDTO: CancelDownloadDTO? = null): Response<Unit>
     ...
     */
    @POST("api/v1/commands/{agentId}/spawn/dotnetassembly")
    suspend fun queueDotNetAsmCommand(@Path("agentId") agentId: kotlin.Int, @Body dotNetAsmDTO: DotNetAsmDTO? = null): Response<Unit>
     ...
     */
    @POST("api/v1/commands/{agentId}/spawn/escalate")
    suspend fun queueEscalateCommand(@Path("agentId") agentId: kotlin.Int, @Body escalateDTO: EscalateDTO? = null): Response<Unit>
     ...
     */
    @POST("api/v1/commands/{agentId}/execute/filedownload")
    suspend fun queueFileDownloadCommand(@Path("agentId") agentId: kotlin.Int, @Body downloadDTO: DownloadDTO? = null): Response<Unit>
     ...
     */
    @POST("api/v1/commands/{agentId}/spawn/killprocess")
    suspend fun queueKillCommand(@Path("agentId") agentId: kotlin.Int, @Body killProcessDTO: KillProcessDTO? = null): Response<Unit>
     ...
     */
    @POST("api/v1/commands/{agentId}/spawn/powershell")
    suspend fun queuePowerShellCommand(@Path("agentId") agentId: kotlin.Int, @Body powerShellDTO: PowerShellDTO? = null): Response<Unit>
     ...
     */
    @POST("api/v1/commands/{agentId}/spawn/runas")
    suspend fun queueRunAsCommand(@Path("agentId") agentId: kotlin.Int, @Body runAsDTO: RunAsDTO? = null): Response<Unit>
     ...
     */
    @POST("api/v1/commands/{agentId}/spawn/run")
    suspend fun queueRunCommand(@Path("agentId") agentId: kotlin.Int, @Body runDTO: RunDTO? = null): Response<Unit>
     ...
     */
    @POST("api/v1/commands/{agentId}/spawn/runu")
    suspend fun queueRunUCommand(@Path("agentId") agentId: kotlin.Int, @Body runUDTO: RunUDTO? = null): Response<Unit>
     ...
     */
    @POST("api/v1/commands/{agentId}/spawn/shell")
    suspend fun queueShellCommand(@Path("agentId") agentId: kotlin.Int, @Body shellDTO: ShellDTO? = null): Response<Unit>
     ...
     */
    @POST("api/v1/commands/{agentId}/execute/upload")
    suspend fun queueUploadCommand(@Path("agentId") agentId: kotlin.Int, @Body uploadDTO: UploadDTO? = null): Response<Unit>
