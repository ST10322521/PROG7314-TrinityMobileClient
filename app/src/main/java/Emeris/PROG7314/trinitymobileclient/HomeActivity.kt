...
//Shell activity: nav drawer + shared app bar.
//Swaps fragments into content_container. Manual nav, no Nav Component.
//View binding renames drawer ids, so nav_logout is binding.navDrawer.navLogout.
